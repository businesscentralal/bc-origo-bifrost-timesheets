...
/// </summary>
permissionset 70009200 "Clockify Full"
{
    Access = Public;
    Assignable = true;
    ...
    Permissions =
        ...
        codeunit "Clockify TimeEntrySyncRng Impl" = X,
        codeunit "Clockify TimeEntry Parse" = X,
        codeunit "Clockify TimeEntry Fetch" = X,
        codeunit "Clockify SyncAllUsers Impl" = X,
        codeunit "Clockify TimeSheet Sync" = X,
        codeunit "Clockify TimeSheetSync Impl" = X,
        codeunit "Clockify TimeSheetSyncRng Impl" = X,
        codeunit "Clockify TimeSheet Mgt" = X,
        codeunit "Clockify TimeSheet Help" = X,
        codeunit "Clockify TimeSheetCreate Impl" = X,
        codeunit "Clockify TimeSheetApprove Impl" = X,
        codeunit "Clockify TimeSheetReject Impl" = X,
        codeunit "Clockify TimeSheetReopen Impl" = X,
        codeunit "Clockify TimeSheetPost Impl" = X,
        codeunit "Clockify TimeSheetArchive Impl" = X,
