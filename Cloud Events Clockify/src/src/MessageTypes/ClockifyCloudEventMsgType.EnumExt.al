...
/// </summary>
enumextension 71410 "Clockify Cloud Event Msg Type" extends "Cloud Event Message Type ori"
{
    /// <summary>Returns a Markdown overview of the Clockify connector and all its message types.</summary>
    value(71420; "Help.Clockify.Get")
    {
    ...
    value(71421; "Clockify.Workspace.List")
    {
    ...
    value(71422; "Clockify.User.GetCurrent")
    {
    ...
    value(71423; "Clockify.User.List")
    {
    ...
    value(71424; "Clockify.Client.List")
    {
    ...
    value(71425; "Clockify.Client.Get")
    {
    ...
    value(71426; "Clockify.Client.Create")
    {
    ...
    value(71427; "Clockify.Client.Update")
    {
    ...
    value(71428; "Clockify.Client.Delete")
    {
    ...
    value(71429; "Clockify.Project.List")
    {
    ...
    value(71430; "Clockify.Project.Get")
    {
    ...
    value(71431; "Clockify.Project.Create")
    {
    ...
    value(71432; "Clockify.Project.Update")
    {
    ...
    value(71433; "Clockify.Project.Delete")
    {
    ...
    value(71434; "Clockify.Task.List")
    {
    ...
    value(71435; "Clockify.Task.Create")
    {
    ...
    value(71436; "Clockify.Task.Update")
    {
    ...
    value(71437; "Clockify.Task.Delete")
    {
    ...
    value(71439; "Clockify.Tag.Create")
    {
    ...
    value(71440; "Clockify.Tag.Update")
    {
    ...
    value(71441; "Clockify.Tag.Delete")
    {
    ...
    value(71442; "Clockify.TimeEntry.List")
    {
    ...
    value(71443; "Clockify.TimeEntry.Get")
    {
    ...
    value(71444; "Clockify.TimeEntry.Create")
    {
    ...
    value(71445; "Clockify.TimeEntry.Update")
    {
    ...
    value(71446; "Clockify.TimeEntry.Delete")
    {
    ...
    value(71448; "Clockify.Currency.List")
    {
    ...
    value(71449; "Clockify.UserGroup.List")
    {
    ...
    value(71450; "Clockify.CustomField.List")
    {
    ...
    value(71453; "Clockify.TimeEntry.Sync")
    {
