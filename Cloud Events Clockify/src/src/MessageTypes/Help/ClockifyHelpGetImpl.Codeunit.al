...
/// body is required.
/// </summary>
codeunit 71420 "Clockify Help Get Impl" implements "Cloud Event Msg Interface ori"
{
    Access = Internal;
    ...
    begin
        ...
        Builder.AppendLine('All message types are **outbound** (Business Central calls Clockify) and use `Content-Type: application/json`.');
        Builder.AppendLine('');
