...
/// </summary>
codeunit 70009263 "Clockify Client Help ori"
{
    Access = Internal;
    ...
    /// <summary>Returns the help document for <c>Clockify.Client.List</c>.</summary>
    /// <param name="Description">The message type description shown in the help header.</param>
    local procedure GetClientListHelp(Description: Text): Text
    var
        HelpBuilder: Codeunit "Clockify Help Builder ori";
    begin
        HelpBuilder.Init('Clockify.Client.List', Description, 'GET', '/workspaces/{workspaceId}/clients');
    ...
    /// <summary>Returns the help document for <c>Clockify.Client.Get</c>.</summary>
    /// <param name="Description">The message type description shown in the help header.</param>
    ...
    /// <summary>Returns the help document for <c>Clockify.Client.Create</c>.</summary>
    /// <param name="Description">The message type description shown in the help header.</param>
    local procedure GetClientCreateHelp(Description: Text): Text
    var
        HelpBuilder: Codeunit "Clockify Help Builder ori";
    begin
        HelpBuilder.Init('Clockify.Client.Create', Description, 'POST', '/workspaces/{workspaceId}/clients');
        HelpBuilder.AddParam('workspaceId', true, 'string', 'Target workspace ID', 'Clockify.Workspace.List → id');
    ...
    /// <summary>Returns the help document for <c>Clockify.Client.Update</c>.</summary>
    /// <param name="Description">The message type description shown in the help header.</param>
    ...
    /// <summary>Returns the help document for <c>Clockify.Client.Delete</c>.</summary>
    /// <param name="Description">The message type description shown in the help header.</param>
