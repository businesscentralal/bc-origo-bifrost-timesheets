...
/// </summary>
codeunit 70009222 "Clockify Project List Impl ori" implements "Msg Interface ori"
{
    Access = Internal;
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Clockify.Project.List", GetDescription()));
    end;
