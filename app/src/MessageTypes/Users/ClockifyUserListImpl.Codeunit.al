...
/// </summary>
codeunit 70009240 "Clockify User List Impl ori" implements "Msg Interface ori"
{
    Access = Internal;
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Clockify.User.List", GetDescription()));
    end;
