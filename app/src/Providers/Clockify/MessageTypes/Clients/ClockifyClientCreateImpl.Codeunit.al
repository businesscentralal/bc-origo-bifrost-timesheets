...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Client.Create</c> message type.
...
codeunit 10036794 "Clockify ClientCreate Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Client.Create", GetDescription()));
    end;
