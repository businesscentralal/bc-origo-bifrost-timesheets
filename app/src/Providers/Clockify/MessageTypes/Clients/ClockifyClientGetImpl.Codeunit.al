...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Client.Get</c> message type.
...
codeunit 10036796 "Clockify Client Get Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Client.Get", GetDescription()));
    end;
