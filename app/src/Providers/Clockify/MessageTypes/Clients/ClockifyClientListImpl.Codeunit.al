...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Client.List</c> message type.
...
codeunit 10036797 "Clockify Client List Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Client.List", GetDescription()));
    end;
