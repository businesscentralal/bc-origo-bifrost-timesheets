...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Client.Update</c> message type.
...
codeunit 10036798 "Clockify ClientUpdate Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Client.Update", GetDescription()));
    end;
