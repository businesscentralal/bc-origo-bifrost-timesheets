...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Currency.List</c> message type.
...
/// as <c>currencyId</c> in the body of <c>Provider.Clockify.Client.Create</c> and
/// <c>Provider.Clockify.Client.Update</c> -- Clockify silently ignores <c>currencyCode</c>
...
codeunit 10036800 "Clockify CurrencyList Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Currency.List", GetDescription()));
    end;
