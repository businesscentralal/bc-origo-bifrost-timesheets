...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Project.Get</c> message type.
...
codeunit 10036806 "Clockify Project Get Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Project.Get", GetDescription()));
    end;
