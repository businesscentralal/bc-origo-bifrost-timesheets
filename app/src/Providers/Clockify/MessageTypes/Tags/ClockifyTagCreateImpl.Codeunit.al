...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Tag.Create</c> message type.
...
codeunit 10036809 "Clockify Tag Create Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Tag.Create", GetDescription()));
    end;
