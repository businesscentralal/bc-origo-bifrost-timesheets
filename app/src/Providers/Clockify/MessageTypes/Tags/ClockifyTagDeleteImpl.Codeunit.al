...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Tag.Delete</c> message type.
/// Deletes a tag by ID.
/// </summary>
codeunit 10036810 "Clockify Tag Delete Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Tag.Delete", GetDescription()));
    end;
