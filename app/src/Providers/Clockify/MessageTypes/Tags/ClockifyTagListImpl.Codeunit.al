...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Tag.List</c> message type.
...
codeunit 10036811 "Clockify Tag List Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Tag.List", GetDescription()));
    end;
