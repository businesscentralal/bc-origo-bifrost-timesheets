...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Task.Delete</c> message type.
...
codeunit 10036814 "Clockify Task Delete Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Task.Delete", GetDescription()));
    end;
