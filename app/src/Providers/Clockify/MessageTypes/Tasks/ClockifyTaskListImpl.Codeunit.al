...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Task.List</c> message type.
...
codeunit 10036815 "Clockify Task List Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Task.List", GetDescription()));
    end;
