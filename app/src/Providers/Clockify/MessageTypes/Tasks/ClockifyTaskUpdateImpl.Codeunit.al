...
/// <summary>
/// Implementation of the <c>Provider.Clockify.Task.Update</c> message type.
...
codeunit 10036816 "Clockify Task Update Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.Task.Update", GetDescription()));
    end;
