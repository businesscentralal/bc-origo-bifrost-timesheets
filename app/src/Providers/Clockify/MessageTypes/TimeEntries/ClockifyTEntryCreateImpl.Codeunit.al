...
/// <summary>
/// Implementation of the <c>Provider.Clockify.TimeEntry.Create</c> message type.
...
codeunit 10036817 "Clockify TEntryCreate Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.TimeEntry.Create", GetDescription()));
    end;
