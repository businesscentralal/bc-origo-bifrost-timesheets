...
/// <summary>
/// Implementation of the <c>Provider.Clockify.TimeEntry.Delete</c> message type.
...
codeunit 10036818 "Clockify TEntryDelete Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.TimeEntry.Delete", GetDescription()));
    end;
