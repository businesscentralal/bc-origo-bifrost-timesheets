...
/// <summary>
/// Implementation of the <c>Provider.Clockify.TimeEntry.Get</c> message type.
...
codeunit 10036819 "Clockify TEntryGet Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Provider.Clockify.TimeEntry.Get", GetDescription()));
    end;
