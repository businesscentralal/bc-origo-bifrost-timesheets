...
/// <summary>
/// Implementation of the <c>Timesheets.TimeSheet.Approve</c> message type. Submits and
...
codeunit 10036835 "Clockify TSheetApprv Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Timesheets.TimeSheet.Approve", GetDescription()));
    end;
