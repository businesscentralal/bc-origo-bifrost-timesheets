...
/// <summary>
/// Implementation of the <c>Timesheets.TimeSheet.Post</c> message type. Transfers approved,
...
codeunit 10036836 "Clockify TSheetPost Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Timesheets.TimeSheet.Post", GetDescription()));
    end;
