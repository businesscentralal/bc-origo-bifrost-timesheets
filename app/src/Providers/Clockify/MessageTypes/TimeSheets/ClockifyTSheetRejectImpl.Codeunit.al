...
/// <summary>
/// Implementation of the <c>Timesheets.TimeSheet.Reject</c> message type. Rejects submitted
...
codeunit 10036843 "Clockify TSheetReject Impl ori" implements "Msg Interface ori"
{
    ...
    begin
        Argument.SetResponseMarkdown(Help.GetHelp(Enum::"Message Type ori"::"Timesheets.TimeSheet.Reject", GetDescription()));
    end;
